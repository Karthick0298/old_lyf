...
const useStyles = makeStyles(theme => ({
	...
	root: {
		maxWidth: 606,
		backgroundImage: theme.palette.sports.backgroundImage,
				...
				<CardContent>
					...
					<ReadMore>
						<Typography variant='h4'>
							Discover sport coaches to clubs, courts and sports events, you can search for drills, open your favourite training plans, our sports
							facilities have everything you need.
						</Typography>
					</ReadMore>
