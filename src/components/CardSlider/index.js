	...
	return (
		<div className={classes.root}>
			<Swiper
				...
				{cardData?.map(item => (
					<SwiperSlide id={item?.mastTtypeUuid} className={classes.slide}>
						<Card className={classes.card}>
							<CardActionArea>
								<CardMedia component='img' height='208' image={item?.image ? item?.image : ''} />
								<CardContent>
									...
									{/* <Typography variant='h6'>Annual Membership start from 11999/-</Typography> */}
								</CardContent>
							</CardActionArea>
						</Card>
					</SwiperSlide>
