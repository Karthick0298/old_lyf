...
export default function SpaPackagesHead() {
	return (
		<SectionHead
			title='Packages'
			Subhead='Spa packages includes:'
			sideBlockImg='https://ik.imagekit.io/lyfngo/web_b2c/public/images/SpaWellness/packagesHead.png'
