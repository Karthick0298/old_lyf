	...
	return (
		<div className={classes.mainsection}>
			...
			<div className={classes.cardmainsec}>
				<Diet
					backgroundImage={`url(${'https://ik.imagekit.io/lyfngo/web_b2c/public/images/picture/weightbg3.png'})`}
					weight={'Womens Health'}
					month={'3 months'}
					offer={'10% off'}
				...
				/>
				<Diet
					backgroundImage={`url(${'https://ik.imagekit.io/lyfngo/web_b2c/public/images/picture/weightbg4.png'})`}
