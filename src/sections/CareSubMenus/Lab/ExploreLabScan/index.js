...
export default function HomeExploreMore() {
	...
	return (
		<div className={classes.mainone}>
			<MoreCard image={'https://ik.imagekit.io/lyfngo/web_b2c/public/images/hospital-care/location.svg'} heading={'Find Labs/ Scan'} subheading={'Select your medical concern for the consultation'} />
			<MoreCard image={'https://ik.imagekit.io/lyfngo/web_b2c/public/images/hospital-care/package-lab.svg'} heading={'Select Test/ Scan'} subheading={'Instant appointment with your preferred doctor'} />
