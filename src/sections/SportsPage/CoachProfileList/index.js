...
// import Filters from '../../../sections/SportsPage/Filters'
...
const cardData = [
	{
		id: 1,
		name: 'Ramesh Tendulkar',
		experience: 'Athletic Trainer, 6 Years Experience Overall',
		location: 'Isha Sports center, Coimbatore',
		phone: 1234567890,
		likes: 89,
		userStories: 123,
		onlineFees: 350,
	...
	},
	{
		...
		location: 'Dev sports center, Coimbatore',
		phone: 8234567890,
		likes: 92,
		userStories: 93,
		onlineFees: 340,
...
const useStyles = makeStyles(theme => ({
	...
	mobileScreenFilterButton: {
		border: `2px solid ${theme.palette.sports.main}`,
		display: 'flex',
		alignItems: 'center',
		paddingInline: 12,
		borderRadius: 30,
	...
	filterCloseIcon: {
		...
		marginInlineStart: 4,
		cursor: 'pointer',
		color: theme.palette.sports.dark,
		'& .MuiSvgIcon-root': {
			fontSize: 20,
			color: theme.palette.sports.main,
		},
...
export default function CoachProfileList() {
	...
	const {loading, setLoading, sportsLocFilters} = useContextApi()
	const {
	...
	const handleMenuItemClick = (event, index, value) => {
		setSportsCoachSearchFilters({...sportsCoachSearchFilters, sortByIndex: index, sortByFilter: value})
		setOpen(false)
	}
	const handleToggle = () => {
	...
	return (
		<div className={classes.root}>
			<Breadcrumbs separator={<NavigateNextIcon fontSize='small' />} aria-label='breadcrumb' className={classes.breadCrumbsNavigation}>
				...
				<Typography variant='h5'>Coaches list</Typography>
			</Breadcrumbs>

			<div className={classes.topSection}>
				<Typography variant='h2' className={classes.title}>
					Best Coaches Masters @ Coimbatore
				</Typography>

				<div className={classes.topSectionSub}>
					<div className={classes.topSectionSubLeft}>
						<Typography variant='h5'>
							{sportsCoachSearchData?.length} Results<span>|</span>
						</Typography>
					...
					<div className={classes.topSectionSubRight}>
						...
						{!isMobile && (
							<div className={classes.filterWrapper}>
								Filters
								<span
									onClick={sportsCoachResetFilters}
									className={classes.filterCloseIcon}
									style={sportsCoachClearFilters ? {visibility: 'visible'} : {visibility: 'hidden'}}>
									<CancelIcon />
								</span>
							</div>
						)}
						{isMobile && (
							<div>
								<MobileFilter
									searchFilters={sportsCoachSearchFilters}
									setSearchFilters={setSportsCoachSearchFilters}
									clearFilters={sportsCoachClearFilters}
									setClearFilters={setSportsCoachClearFilters}
									budgetValue={budgetValue}
									appointmentChecked={appointmentChecked}
									setAppointmentChecked={setAppointmentChecked}
									setOffset={setSportsCoachOffset}
									locationFilters={sportsLocFilters}
									resetFilters={sportsCoachResetFilters}
									mainColor='#F0662E'
			...
			<div className={classes.mainSection}>
				<div className={classes.profileList}>
					<ProfileListCard2
						...
						searchData={sportsCoachSearchData}
						profilePath=''
						fontColor='#EF5618'
						btnColor={classes.findMorebtn}
						...
						hasMore={hasMore}
						consultMethod={{methodOne: 'For Club', methodTwo: 'For Online', methodThree: 'For Home'}}
						availabilityMethod={{methodOne: 'Club', methodTwo: 'Video call', methodThree: 'Home visit'}}
					/>
				</div>
				{!isMobile && (
