...
import SportsWellnessArticlesCardDetails from '../../../model/SportsWellnessArticlesCardDetails/data'
import React, {useState, useEffect} from 'react'
import SportsArticleApi from '../../../../Service/LandingPage/Sports/SportsArticle'
...
export default function WellnessArticles() {
	...
	useEffect(() => {
		...
		SportsArticleApi.SportsArticle().then(onSuccess, onFailure)
	}, [])
	return (
