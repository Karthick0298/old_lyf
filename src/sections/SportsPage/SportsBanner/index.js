...
function FitnessBannerImage() {
	...
	return (
		<div className={classes.StayHome}>
			<Image src='https://ik.imagekit.io/lyfngo/web_b2c/public/images/Sports/sportsBanner.png' alt='stayhome' objectFit='cover' width={1500} height={360} layout='responsive' />
