...
// import Filters from '../../../sections/MindPage/TherapistFilter'
...
import useMindTherapistContext from '../../../../lib/Utils/hooks/useMindTherapistContext'
...
export default function MastersProfileList() {
	...
	const handleMenuItemClick = (event, index, value) => {
		setMindTherapistSearchFilters({...mindTherapistSearchFilters, sortByIndex: index, sortByFilter: value})
		setOpen(false)
	}
	const handleToggle = () => {
	...
	return (
		<div className={classes.root}>
			<Breadcrumbs separator={<NavigateNextIcon fontSize='small' />} aria-label='breadcrumb' className={classes.breadCrumbsNavigation}>
				...
				<Typography variant='h5'>Yoga Therapist list</Typography>
			</Breadcrumbs>

			<div className={classes.topSection}>
				<Typography variant='h2' className={classes.title}>
					Best Yoga Therapist @ Chennai
				</Typography>

				<div className={classes.topSectionSub}>
					<div className={classes.topSectionSubLeft}>
						<Typography variant='h5'>
							{mindTherapistSearchData?.length} Results<span>|</span>
						</Typography>
					...
					<div className={classes.topSectionSubRight}>
						...
						{!isMobile && (
							<div className={classes.filterWrapper}>
								Filters
								<span
									onClick={mindTherapistResetFilters}
									className={classes.filterCloseIcon}
									style={mindTherapistClearFilters ? {visibility: 'visible'} : {visibility: 'hidden'}}>
									<CancelIcon />
								</span>
							</div>
						)}
						{isMobile && (
							<div>
								<MobileFilter
									searchFilters={mindTherapistSearchFilters}
									setSearchFilters={setMindTherapistSearchFilters}
									clearFilters={mindTherapistClearFilters}
									setClearFilters={setMindTherapistClearFilters}
									budgetValue={budgetValue}
									appointmentChecked={appointmentChecked}
									setAppointmentChecked={setAppointmentChecked}
									setOffset={setMindTherapistOffset}
									locationFilters={mindLocFilters}
									resetFilters={mindTherapistResetFilters}
									mainColor='#0CC593'
			...
			<div className={classes.mainSection}>
				<div className={classes.profileList}>
					<ProfileListCard2
						...
						searchData={mindTherapistSearchData}
						profilePath=''
						fontColor='#0CC593'
						btnColor={classes.findMorebtn}
