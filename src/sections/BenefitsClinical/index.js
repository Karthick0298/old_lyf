...
import Benefitsclinical from '../../components/NumeroListGrid'
...
export default function CareBenefitsClinical() {
		...
		<div className={classes.Positionroot}>
			<div className={classes.doctorPosition}>
				<div className={classes.leftSidePosition}>
					...
					<Typography variant='h2'>Clinical Consultation</Typography>
				</div>
			</div>
			<Benefitsclinical />
		</div>
