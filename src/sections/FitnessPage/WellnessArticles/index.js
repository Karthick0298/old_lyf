...
import FitnessArticlesApi from '../../../../Service/LandingPage/Fitness/FitnessArticles'
...
export default function WellnessArticles() {
	...
	useEffect(() => {
		...
		FitnessArticlesApi.FitnessArticles().then(onSuccess, onFailure)
	}, [])
	return (
		<div className={classes.PositionMainroot}>
			...
			<div className={classes.Positionroot}>
				<div className={classes.gfg}>
					<Image
						src={singleImg?.thumbnailImageUrl ? singleImg?.thumbnailImageUrl : 'https://ik.imagekit.io/lyfngo/web_b2c/public/images/picture/wellnessheadache.png'}
						quality={100}
						alt='articles'
						width={520}
						height={400}
