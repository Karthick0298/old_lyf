import {makeStyles, MenuList, Typography, Button} from '@material-ui/core'
import React, {useEffect, useState, useCallback} from 'react'
import MenuListFolder from '../../../components/MenuList'
...
function AppoinmentLayout(props) {
	...
	const {user, practicelist, setPracticeName, practiceName, MultiUserDetail} = useAuth()

	// const [practicelist, setPracticeList] = useState([])

	// const userId = typeof window !== 'undefined' ? secureLocalStorage.getItem('userId') : ''
	...
	return (
		<DashboardEllusion>
			<div className={classes.appoinmentBgcolor}>
				...
				<PracticeDropdown practicelist={practicelist} setPracticeName={setPracticeName} practiceName={practiceName} />
