			...
			<div className={classes.maxWidthControl}>
					...
					<div className={classes.sec1}>
						<div className={classes.sec11}>
							...
							<Typography variant='subtitle1'>
								...
								crucial data of an app or website. Precisely it facilitates you with data related to <i>revenue and sales </i>of a niche. The
						...
						<div className={classes.sec12}>
							<Image
								src={'https://ik.imagekit.io/LyfngoDev/B2C/StaticPages/Images/dashboardScreen.png'}
				...
				<PageFadeEffect>
					<div className={classes.sec2}>
						...
						<div className={classes.sec22}>
							...
							<Typography variant='subtitle1'>
								<i>Analytics</i> is a very crucial part of any business. It may be a small picture illustration, but it gives a quick peek into the
							...
							<Typography variant='subtitle1'>
								...
								<i>customer, appointment, revenue, and growth.</i>
							</Typography>
						</div>
					</div>
				</PageFadeEffect>
					...
					<div className={classes.sec3}>
						<div className={classes.sec31}>
							...
							<Typography variant='subtitle1'>
								...
								include; <i>walk-in, home-visits, in-person, and online.</i>
							</Typography>
						</div>
				...
				<PageFadeEffect>
					<div className={classes.sec4}>
						...
						<div className={classes.sec42}>
							...
							<Typography variant='subtitle1'>
								This chart exhibits the revenue generation for a selected period which can be <i>daily, weekly, monthly, or even yearly.</i>
							</Typography>
							<Typography variant='subtitle1'>
								The dashboard helps you to <i>analyze your work,</i> as well as revenue generation, at a glance. It allows you to monitor the progress
								of all your clinics on the same page.
							</Typography>
						</div>
					</div>
				</PageFadeEffect>
				...
				<PageFadeEffect>
					<div className={classes.sec5}>
						...
						<Typography variant='subtitle1'>
							The report is a <i>one-stop page</i> where you can access all your invoices like; income, payments, new customers, appointments, billing
						...
						<div className={classes.sec51}>
							<div className={classes.sec511}>
								...
								<Typography variant='subtitle1'>
									The <i>new customer's section and appointments sections</i> display details of customers that include vitals like the blood group
