...
import SpaWellnessArticlesCardDetails from '../../../model/SpaWellnessArticlesCardDetails/index'
import React, {useState, useEffect} from 'react'
import SpaArticleApi from '../../../../Service/LandingPage/Spa/SpaArticle'
...
export default function WellnessArticles() {
	...
	useEffect(() => {
		...
		SpaArticleApi.SpaArticle().then(onSuccess, onFailure)
	}, [])
	return (
