...
// import Filters from '../../../sections/SpaWellnessPage/TherapistFilter'
import ProfileListCard from '../../../components/ProfileListCard'
import MobileFilter from '../../../sections/SpaWellnessPage/TherapistFilter/MobileFilter'
...
import useSpaTherapistContext from '../../../../lib/Utils/hooks/useSpaTherapistContext'
...
export default function TherapistProfileList() {
	...
	const handleMenuItemClick = (event, index, value) => {
		setSpaTherapistSearchFilters({...spaTherapistSearchFilters, sortByIndex: index, sortByFilter: value})
		setOpen(false)
	}
	const handleToggle = () => {
	...
	return (
		<div className={classes.root}>
			<Breadcrumbs separator={<NavigateNextIcon fontSize='small' />} aria-label='breadcrumb' className={classes.breadCrumbsNavigation}>
				...
				<Typography variant='h5'>Therapists List</Typography>
			</Breadcrumbs>

			<div className={classes.topSection}>
				<Typography variant='h2' className={classes.title}>
					Best Therapists @ Coimbatore
				</Typography>

				<div className={classes.topSectionSub}>
					<div className={classes.topSectionSubLeft}>
						<Typography variant='h5'>
							{spaTherapistSearchData?.length} Results<span>|</span>
						</Typography>
					...
					<div className={classes.topSectionSubRight}>
						...
						{!isMobile && (
							<div className={classes.filterWrapper}>
								Filters
								<span
									onClick={spaTherapistResetFilters}
									className={classes.filterCloseIcon}
									style={spaTherapistClearFilters ? {visibility: 'visible'} : {visibility: 'hidden'}}>
									<CancelIcon />
								</span>
							</div>
						)}
						{isMobile && (
							<div>
								<MobileFilter
									searchFilters={spaTherapistSearchFilters}
									setSearchFilters={setSpaTherapistSearchFilters}
									clearFilters={spaTherapistClearFilters}
									setClearFilters={setSpaTherapistClearFilters}
									budgetValue={budgetValue}
									appointmentChecked={appointmentChecked}
									setAppointmentChecked={setAppointmentChecked}
									setOffset={setSpaTherapistOffset}
									locationFilters={spaLocFilters}
									resetFilters={spaTherapistResetFilters}
									mainColor='#ff2083'
			...
			<div className={classes.mainSection}>
				<div className={classes.profileList}>
					<ProfileListCard2
						...
						searchData={spaTherapistSearchData}
						profilePath=''
						fontColor='#E1087E'
						btnColor={classes.findMorebtn}
