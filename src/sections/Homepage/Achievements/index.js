	...
	return (
		<div className={classes.container}>
			...
			<Typography variant='body1'>
				We are a strong team with great professional and technical support providing services which make our happy customers who made us reach heights
				as one of the top rated apps.
			</Typography>
